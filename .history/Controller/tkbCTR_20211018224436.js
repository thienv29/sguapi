...
const tkbCTR = {
    getTkb(req, res, next) {
        function dispatchTable2(table) {
            ...
            const thu = Array.from(table.querySelectorAll("tbody tr td:nth-child(9) > *"))
            .map(
                 (e) => {
                      return e.textContent;
                 }
            );
            const tbd = Array.from(table.querySelectorAll("tbody tr td:nth-child(10)  > *"))
            .map(
                 (e) => {
                      return e.textContent;
                 }
            );
            const st = Array.from(table.querySelectorAll("tbody tr td:nth-child(11)  > *"))
            .map(
                 (e) => {
                      return e.textContent;
                 }
            ...
            return {
                 id,name,nmh,stc,thu,tbd,st,room,
            };
       }
