...
const tkbCTR = {
    getTkb(req, res, next) {
        function dispatchTable2(table) {
            ...
            const id = table.querySelector("tbody tr td:nth-child(1)").text;
            const name = table.querySelector("tbody tr td:nth-child(2)").text;
            const nmh = table.querySelector("tbody tr td:nth-child(3)").text;
            const stc = table.querySelector("tbody tr td:nth-child(4)").text;
