...
const tkbCTR = {
    getTkb(req, res, next) {
        function dispatchTable2(table) {
            ...
            const id = table.querySelector("tbody tr td:nth-child(1)").textc;
            const name = table.querySelector("tbody tr td:nth-child(2)").textc;
            const nmh = table.querySelector("tbody tr td:nth-child(3)").textc;
            const stc = table.querySelector("tbody tr td:nth-child(4)").textc;
